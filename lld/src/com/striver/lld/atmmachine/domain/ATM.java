...
import com.striver.lld.atmmachine.domain.state.IdleState;
import com.striver.lld.atmmachine.domain.state.SupportsNotes;
...
public class ATM {
    ...
    public void attachServices(CardService cardService, SessionService sessionService,
    ...
    private void autoNext() {
        ...
        if (next != null && next != currentState) {
            System.out.println(
                    "[STATE] " + currentState.getClass().getSimpleName() + " → " + next.getClass().getSimpleName());
