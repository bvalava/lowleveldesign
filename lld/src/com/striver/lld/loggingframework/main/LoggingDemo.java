package com.striver.lld.loggingframework.main;

import com.striver.lld.loggingframework.appenders.ConsoleAppender;
import com.striver.lld.loggingframework.appenders.FileAppender;
import com.striver.lld.loggingframework.core.LogLevel;
import com.striver.lld.loggingframework.core.Logger;
import com.striver.lld.loggingframework.core.LoggerImpl;
import com.striver.lld.loggingframework.filter.LevelFilter;
import com.striver.lld.loggingframework.formatters.SimpleFormatter;
...
public class LoggingDemo {
    ...
    private static void demoMultipleAppenders() {
        ...
        // Add file appender
        FileAppender fileAppender = new FileAppender("demo");
        logger.addAppender(fileAppender);

        logger.info("This message goes to both console and file");
        logger.error("This error also goes to both destinations");

        System.out.println("Check 'demo' file for the logged messages");
        System.out.println();
    }
