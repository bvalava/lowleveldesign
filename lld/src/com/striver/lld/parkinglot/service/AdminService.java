...
import com.striver.lld.parkinglot.repository.FloorRepository;
import com.striver.lld.parkinglot.repository.PricingRuleRepository;
import com.striver.lld.parkinglot.repository.SlotRepository;
...
public class AdminService {
    ...
    public void initializeParkingLot() {
        ...
        System.out.println("[SERVICE] Initializing parking slot with default configuration");
    ...
    public void updatePricingRule(Vehicle.VehicleType vehicleType, double ratePerHour, double flatRate) {
        ...
        PricingRule rule = pricingRuleRepository.findByVehicleType(vehicleType).orElseThrow(() -> new IllegalStateException("PricingRule not found"));
