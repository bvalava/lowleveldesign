package com.striver.lld.vendingmachine.service;

import com.striver.lld.vendingmachine.domain.*;
import com.striver.lld.vendingmachine.domain.state.IdleState;
import com.striver.lld.vendingmachine.domain.state.VendingMachineState;
...
public class RecoveryService {
    ...
    public void performRecovery(int machineId) {
        ...
        VendingMachine machine1 = vendingMachineRepository.findById(machineId);
        if (machine1 != null) {
